<?php
   ...
   $subject = $_POST['subject'];
    ...
    if ($_FILES['upload']['size'] >= 3072) {
        ...
        $test_filepath = $file_dir.$file_token."/".$file_token.".".$file_ext;
        $changed_Filename = $file_token.".".$file_ext;
        ...
        $stmt->bindValue(':changedFilename', $changed_Filename);
        ...
        if ($_FILES['upload']['size']==0) {
            ...
            $stmt->bindValue(':changedFilename', NULL);
